...
> <img src="./media/image1.png" style="width:6.21051in;height:1.92221in"
...
> <img src="./media/image2.png" style="width:5.37469in;height:3.23572in"
...
> <img src="./media/image3.png" style="width:1.8773in;height:1.69415in"
...
> <img src="./media/image4.png" style="width:5.04074in;height:2.34098in"
...
> <img src="./media/image5.png" style="width:5.85245in;height:2.13777in"
...
> <img src="./media/image6.png" style="width:5.25333in;height:3.38548in"
> alt="select as described" />

13. Go back to the model. Click the chevron button on the **+ Add**
    button and select **Field**.

> <img src="./media/image7.png" style="width:5.89728in;height:1.93804in"
> alt="select as described" />

14. Enter **Owner Name** and click **Done**.

> <img src="./media/image8.png" style="width:3.56616in;height:2.20454in"
...
> <img src="./media/image9.png" style="width:5.40839in;height:3.09711in"
...
> <img src="./media/image10.png" style="width:5.47537in;height:2.27614in"
> alt="select as described" />
...
> <img src="./media/image11.png" style="width:4.02554in;height:1.65193in"
> alt="select as described" />

27. Enter **Budget Category** and click **Rename**.

> <img src="./media/image12.png" style="width:4.11431in;height:1.90902in"
> alt="enter details as described" />

28. Click **+** **New column**.

> <img src="./media/image13.png" style="width:4.72788in;height:1.15066in"
> alt="select as described" />
...
> <img src="./media/image14.png" style="width:4.83007in;height:2.8067in"
...
> <img src="./media/image15.png" style="width:5.5557in;height:1.8519in"
> alt="select as described" />

2.  Enter **Sample documents** for collection name and click **+** add.

> <img src="./media/image16.png" style="width:2.53767in;height:1.95586in"
> alt="select as described" />
...
> <img src="./media/image17.png" style="width:4.53623in;height:1.77281in"
...
> <img src="./media/image18.png" style="width:4.78016in;height:3.50392in"
...
> <img src="./media/image19.png" style="width:5.38996in;height:1.89858in"
> alt="select as described" />

2.  Select on the address and select **Property Address** as field.

> <img src="./media/image20.png" style="width:5.57969in;height:1.92547in"
> alt="select as described" />
...
> <img src="./media/image21.png" style="width:4.96767in;height:1.97539in"
> alt="review the page" />

7.  Select table area of the document and select **Budget Items** table.

> <img src="./media/image22.png" style="width:5.4132in;height:2.65108in"
> alt="select as described" />

8.  Turn on **Advanced tagging mode**.

> <img src="./media/image23.png" style="width:5.8628in;height:1.39353in"
> alt="select as described" />

9.  Click to select the first cell.

> <img src="./media/image24.png" style="width:5.05462in;height:2.15163in"
> alt="select as described" />

10. Go to the document and select the first budget category item name.

> <img src="./media/image25.png" style="width:5.94137in;height:0.96547in"
> alt="select as described" />

11. The selection should automatically advance to the second cell.
    Select first budget category item amount.

> <img src="./media/image26.png" style="width:6.24922in;height:1.49981in"
> alt="select as described" />
...
> <img src="./media/image27.png" style="width:5.93676in;height:1.38524in"
> alt="select as described" />
...
> <img src="./media/image28.png" style="width:5.93611in;height:3.06382in"
> alt="review the resulting page" />

15. Select the second document.

> <img src="./media/image29.png" style="width:4.9767in;height:2.16563in"
> alt="select as described" />

16. Tag the fields and for the second document.

> <img src="./media/image30.png" style="width:5.62225in;height:1.85126in"
> alt="select as described" />

17. Select table area of the document and select **Budget Items** table.

> <img src="./media/image31.png" style="width:5.73933in;height:2.47355in"
> alt="select as described" />
...
> <img src="./media/image32.png" style="width:4.04329in;height:4.08393in"
> alt="select as described" />
...
> <img src="./media/image33.png" style="width:5.34603in;height:2.23779in"
> alt="select as described" />

23. Click **Train** and wait for the training to complete.

> <img src="./media/image34.png" style="width:4.37941in;height:2.36657in"
> alt="select as described" />
...
> <img src="./media/image35.png" style="width:5.51187in;height:1.67947in"
> alt="review and test" />
...
> <img src="./media/image36.png" style="width:3.82541in;height:2.24413in"
> alt="review and test" />

7.  You should see the budget items from the test file.

> <img src="./media/image37.png" style="width:5.07516in;height:2.54138in"
> alt="review results" />
...
> <img src="./media/image38.png" style="width:5.53771in;height:3.20016in"
> alt="publish" />
...
> <img src="./media/image39.png" style="width:5.49167in;height:1.90096in"
> alt="select as described" />

6.  Click **+** insert new step after the **Get loan** step and select
    **Add an action**.

> <img src="./media/image40.png" style="width:5.82201in;height:1.78061in"
> alt="add an action" />
...
> <img src="./media/image41.png" style="width:4.81115in;height:2.19792in"
> alt="select as described" />
...
> <img src="./media/image42.png" style="width:5.16836in;height:1.87961in"
> alt="select as described" />
...
> <img src="./media/image43.png" style="width:5.0462in;height:3.83587in"
...
> <img src="./media/image44.png" style="width:5.82458in;height:2.14564in"
> alt="add an action to the no branch" />

24. Select **Get attachment (V2).**

> <img src="./media/image45.png" style="width:4.52188in;height:2.56477in"
> alt="select as described" />
...
> <img src="./media/image46.png" style="width:5.19345in;height:1.95698in"
...
> <img src="./media/image47.png" style="width:4.45924in;height:2.29632in"
...
> <img src="./media/image48.png" style="width:5.39587in;height:2.27365in"
> alt="select as described" />
...
> <img src="./media/image49.png" style="width:5.09722in;height:2.51623in"
> alt="select as described" />
...
> <img src="./media/image51.png" style="width:5.12782in;height:2.61455in"
> alt="select and complete as described" />
...
> <img src="./media/image52.png" style="width:5.51966in;height:2.28217in"
> alt="select and complete as described" />
...
> <img src="./media/image53.png" style="width:4.35486in;height:3.74403in"
> alt="select and complete as described" />

42. Add comma and space in front of the value.

> <img src="./media/image54.png" style="width:4.89526in;height:2.45193in"
> alt="select and complete as described" />
...
> <img src="./media/image55.png" style="width:5.21222in;height:2.34717in"
> alt="select and complete as described" />

47. Select **Draw Amount value** and click **OK**.

> <img src="./media/image56.png" style="width:5.26821in;height:2.41178in"
> alt="select and complete as described" />
...
> <img src="./media/image57.png" style="width:5.63131in;height:1.77061in"
> alt="select and complete as described" />
...
> <img src="./media/image58.png" style="width:4.56684in;height:2.61402in"
> alt="select and complete as described" />
...
> <img src="./media/image59.png" style="width:4.23974in;height:2.1819in"
> alt="select and complete as described" />
...
> <img src="./media/image60.png" style="width:4.00462in;height:2.15719in"
> alt="select and complete as described" />
...
> <img src="./media/image61.png" style="width:5.52944in;height:1.00782in"
...
> <img src="./media/image62.png" style="width:3.68729in;height:4.88898in"
> alt="review the output" />

58. Expand the **Run inspection process** and review the **Work** input.

> <img src="./media/image63.png" style="width:3.50885in;height:2.4807in"
> alt="review the output" />
